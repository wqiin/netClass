#############################################################################
# Makefile for building: CURL_GITHUB
# Generated by qmake (3.1) (Qt 6.7.3)
# Project:  CURL_GITHUB.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile CURL_GITHUB.pro
#############################################################################
...
INCPATH       = -I. -I../../zd_code/curl/ -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I. -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk/System/Library/Frameworks/AGL.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk/System/Library/Frameworks/AGL.framework/Headers -I/opt/homebrew/share/qt/mkspecs/macx-clang -F/opt/homebrew/lib
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = CURL_GITHUB1.0.0
DISTDIR = /Users/wqiin/git/netClass/.tmp/CURL_GITHUB1.0.0
...
LIBS          = $(SUBLIBS) -F/opt/homebrew/lib -lcurl -framework QtGui -framework AppKit -framework ImageIO -framework Metal -framework QtCore -framework IOKit -framework DiskArbitration -framework AGL -framework OpenGL   
...
SOURCES       = cftpsclient.cpp \
		chttpclient.cpp \
		chttpserver.cpp \
		main.cpp 
OBJECTS       = cftpsclient.o \
		chttpclient.o \
		chttpserver.o \
		main.o
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		/opt/homebrew/share/qt/mkspecs/features/cmdline.prf \
		...
		CURL_GITHUB.pro cftpsclient.h \
		chttpclient.h \
		chttpserver.h cftpsclient.cpp \
		chttpclient.cpp \
		chttpserver.cpp \
		main.cpp
QMAKE_TARGET  = CURL_GITHUB
DESTDIR       = 
TARGET        = CURL_GITHUB
...
EXPORT__QMAKE_STASH_ = /Users/wqiin/git/netClass/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/wqiin/git/netClass/CURL_GITHUB.pro
...
Makefile: CURL_GITHUB.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.7.3/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.7.3/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.7.3/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile CURL_GITHUB.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents cftpsclient.h chttpclient.h chttpserver.h $(DISTDIR)/
	$(COPY_FILE) --parents cftpsclient.cpp chttpclient.cpp chttpserver.cpp main.cpp $(DISTDIR)/
...
cftpsclient.o: cftpsclient.cpp cftpsclient.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o cftpsclient.o cftpsclient.cpp

chttpclient.o: chttpclient.cpp chttpclient.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o chttpclient.o chttpclient.cpp

chttpserver.o: chttpserver.cpp chttpserver.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o chttpserver.o chttpserver.cpp

main.o: main.cpp cftpsclient.h \
		chttpclient.h
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/CURL_GITHUB/bin || mkdir -p $(INSTALL_ROOT)/opt/CURL_GITHUB/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/CURL_GITHUB/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/CURL_GITHUB/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/CURL_GITHUB/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/CURL_GITHUB/bin/ 
